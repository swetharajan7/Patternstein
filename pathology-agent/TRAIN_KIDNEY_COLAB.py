# ========================================
# KIDNEY CANCER TRAINING - STANDALONE
# ========================================
...
# STEP 5: Download KIDNEY Dataset
print("\n🎯 Training KIDNEY Cancer Model")
!kaggle datasets download -d nazmul0087/ct-kidney-dataset-normal-cyst-tumor-and-stone
!unzip -q ct-kidney-dataset-normal-cyst-tumor-and-stone.zip -d data/
print("✅ Kidney dataset downloaded")

# STEP 6: Organize Data
def organize_kidney_data():
    """Organize kidney data: Normal=normal, Cyst/Tumor/Stone=cancer"""
    ...
    # Map: Normal = normal, everything else = cancer
    mapping = {
        'normal': 'normal',
        'cyst': 'cancer',
        'tumor': 'cancer',
...
plt.title('Kidney Cancer - Accuracy')
plt.legend()
plt.grid(True)
...
print("\n💾 Model saved: kidney_cancer_model.h5")

# STEP 13: Download Model
files.download('kidney_cancer_model.h5')
...
# Save selections
os.makedirs("samples_kidney", exist_ok=True)
shutil.copy2(f"{normal_dir}/{normal_imgs[normal_idx]}", "samples_kidney/kidney_normal.jpg")
shutil.copy2(f"{cancer_dir}/{cancer_imgs[cancer_idx]}", "samples_kidney/kidney_cancer.jpg")

!zip -q samples_kidney.zip samples_kidney/*
files.download("samples_kidney.zip")

print("\n🎉 KIDNEY CANCER TRAINING COMPLETE!")
print("✅ Downloaded: kidney_cancer_model.h5")
print("✅ Downloaded: samples_kidney.zip")
