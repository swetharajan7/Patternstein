# ========================================
# CERVICAL CANCER TRAINING - STANDALONE
# ========================================
...
# STEP 5: Download CERVICAL Dataset
print("\n🎯 Training CERVICAL Cancer Model")
!kaggle datasets download -d paultimothymooney/cervical-cancer-screening
!unzip -q cervical-cancer-screening.zip -d data/
print("✅ Cervical dataset downloaded")

# STEP 6: Organize Data
def organize_cervical_data():
    """Organize cervical data: Type_1=normal, Type_2/3=cancer"""
    ...
    # Map: Type_1 = normal, Type_2 & Type_3 = cancer
    mapping = {
        'type_1': 'normal',
        'type_2': 'cancer', 
        'type_3': 'cancer'
...
plt.title('Cervical Cancer - Accuracy')
plt.legend()
plt.grid(True)
...
plt.title('Cervical Cancer - Loss')
plt.legend()
plt.grid(True)
plt.show()
...
print("\n💾 Model saved: cervical_cancer_model.h5")

# STEP 13: Download Model
files.download('cervical_cancer_model.h5')
...
# Save selections
os.makedirs("samples_cervical", exist_ok=True)
shutil.copy2(f"{normal_dir}/{normal_imgs[normal_idx]}", "samples_cervical/cervical_normal.jpg")
shutil.copy2(f"{cancer_dir}/{cancer_imgs[cancer_idx]}", "samples_cervical/cervical_cancer.jpg")

!zip -q samples_cervical.zip samples_cervical/*
files.download("samples_cervical.zip")

print("\n🎉 CERVICAL CANCER TRAINING COMPLETE!")
print("✅ Downloaded: cervical_cancer_model.h5")
print("✅ Downloaded: samples_cervical.zip")
